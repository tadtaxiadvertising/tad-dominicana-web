    ...
    <section className="py-10 md:py-14 border-t border-gray-800 bg-[#0f172a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-8">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#FFD700]">Actívate en 3 pasos</p>
            ...
            return (
              <div key={item.title} className="relative rounded-2xl border border-gray-800 bg-gray-900/80 p-5 md:p-6 shadow-lg shadow-black/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[#FFD700]">{item.title}</p>
            ...
            return (
              <div key={item.question} className="rounded-2xl border border-gray-800 bg-[#111827] overflow-hidden">
                ...
                >
                  ...
                  <ChevronDown className={`w-5 h-5 text-[#FFD700] transition-transform ${isOpen ? 'rotate-180' : ''}`} />
                </button>
                {isOpen && (
    ...
    <div className="animate-fade-in">
      ...
      <section className="py-16 bg-gradient-to-b from-[#111827] to-gray-900 border-t border-gray-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-[#FFD700]/20 bg-[#FFD700]/10 p-6 md:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <p className="text-sm uppercase tracking-[0.2em] text-[#FFD700] font-semibold">Registro guiado</p>
            ...
            <button onClick={() => navigateTo('register')} className="w-full md:w-auto bg-[#FFD700] text-gray-900 px-6 py-4 rounded-2xl font-bold hover:bg-yellow-400 transition-all shadow-[0_0_20px_rgba(255,215,0,0.2)]">
    ...
    return (
      <div>
        ...
        <input
          ...
          className={`w-full rounded-2xl border px-4 py-3 text-white placeholder:text-gray-500 bg-gray-950/80 focus:outline-none transition-colors ${error ? 'border-red-500 focus:border-red-400' : 'border-gray-700 focus:border-[#FFD700]'}`}
        />
        <p className={`mt-2 text-sm ${error ? 'text-red-400' : 'text-gray-500'}`}>{error || helper}</p>
      </div>
    );
  };
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-6 items-start">
        <div className="bg-gray-800 border border-gray-700 rounded-3xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-gray-900 via-gray-900 to-[#1f2937] px-5 py-6 md:px-8 border-b border-gray-700">
            <div className="flex flex-col gap-5">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm uppercase tracking-[0.2em] text-[#FFD700] font-semibold">Registro de choferes</p>
              ...
              <div>
                ...
                <div className="h-2 w-full rounded-full bg-gray-700 overflow-hidden">
                  <div className="h-full rounded-full bg-gradient-to-r from-[#FFD700] to-yellow-300 transition-all" style={{ width: `${completionRatio}%` }} />
                </div>
              </div>
          ...
          <div className="p-5 md:p-8">
            {step === 1 && (
              <div className="animate-fade-in">
                ...
                <div className="mt-8 flex justify-end">
                  <button onClick={nextStep} className="w-full md:w-auto bg-[#FFD700] text-gray-900 px-6 py-3 rounded-2xl font-bold hover:bg-yellow-400 transition-colors">Continuar con datos del vehículo</button>
                </div>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="animate-fade-in">
                <h3 className="text-xl font-bold text-white mb-2 flex items-center"><Car className="mr-2 text-[#FFD700]" /> Datos del vehículo</h3>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-2xl border border-gray-700 px-4 py-3 text-white bg-gray-950/80 focus:outline-none focus:border-[#FFD700]"
                    >
                    ...
                    <p className="mt-2 text-sm text-gray-500">Selecciona la modalidad con la que trabajas la mayor parte del tiempo.</p>
                  </div>
                </div>
                <div className="mt-8 flex flex-col-reverse md:flex-row md:justify-between gap-3">
                  ...
                  <button onClick={nextStep} className="w-full md:w-auto bg-[#FFD700] text-gray-900 px-6 py-3 rounded-2xl font-bold hover:bg-yellow-400 transition-colors">Revisar y confirmar</button>
                </div>
              </div>
            )}
            ...
            {step === 3 && (
              <div className="animate-fade-in">
                <h3 className="text-xl font-bold text-white mb-2 flex items-center"><FileText className="mr-2 text-[#FFD700]" /> Confirmación y contrato</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  {Object.entries(formData).map(([key, value]) => (
                    <div key={key} className="rounded-2xl border border-gray-700 bg-gray-900/60 p-4">
                      <p className="text-xs uppercase tracking-[0.15em] text-gray-500">{fieldLabels[key]}</p>
                ...
                <div className="flex items-start mb-4">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    {submissionAttempted && !agreed && <p className="text-red-400 mt-2">Debes aceptar los términos para continuar.</p>}
                  </div>
                </div>
                ...
                <div className="flex flex-col-reverse md:flex-row md:justify-between gap-3">
                  ...
                  <button onClick={handleComplete} disabled={isSubmitting} className="w-full md:w-auto px-6 py-3 rounded-2xl font-bold flex items-center justify-center transition-all bg-[#FFD700] text-gray-900 hover:bg-yellow-400 hover:scale-[1.01] shadow-[0_0_15px_rgba(255,215,0,0.3)] disabled:opacity-60 disabled:hover:scale-100">
        ...
        <aside className="space-y-6 xl:sticky xl:top-24">
          <div className="rounded-3xl border border-gray-700 bg-gray-900/80 p-6 shadow-xl">
            ...
            <ul className="mt-4 space-y-4 text-sm text-gray-300">
              ...
              <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5" /> Usa un WhatsApp activo porque por ahí recibirás el enlace de pago.</li>
              <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5" /> Escribe la placa exactamente como aparece en tu vehículo: 1 letra + 6 números.</li>
              <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-green-400 mt-0.5" /> Ten a mano tu número de ficha asignado por la base.</li>
            </ul>
          </div>
